...
import { ModalButtons } from '../utils/ui/ModalButton';
...
export const TimerFormModal: React.FC<TimerFormModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setHours(timer ? Math.floor(timer.duration / 3600) : 0);
      setMinutes(timer ? Math.floor((timer.duration % 3600) / 60) : 0);
      setSeconds(timer ? timer.duration % 60 : 0);
      setTouched({
        title: false,
        hours: false,
        minutes: false,
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              maxLength={50}
              className={`border border-gray-300 w-full rounded-md shadow-sm px-3 py-2  ${
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="border border-gray-300 w-full px-3 py-2 rounded-md shadow-sm "
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            <ModalButtons
              ...
              submitText={timer ? 'Save Changes' : 'Add Timer'}
            />
          </div>
        </form>
      </div>
